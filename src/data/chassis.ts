...
export const chassisList: Chassis[] = [
  ...
  chassis({ slug: "e36-compact", code: "E36 Compact", name: { pl: "3 Compact", en: "3 Compact" }, years: "1994–2000", yearStart: 1994, yearEnd: 2000, tag: "volume", family: "3", extraSearch: ["compact"] }),
  ...
  chassis({ slug: "e46-compact", code: "E46 Compact", name: { pl: "3 Compact", en: "3 Compact" }, years: "2000–2004", yearStart: 2000, yearEnd: 2004, tag: "volume", family: "3" }),
  ...
  chassis({ slug: "f34", code: "F34", name: { pl: "Seria 3 GT", en: "3 Series GT" }, years: "2013–2019", yearStart: 2013, yearEnd: 2019, tag: "volume", family: "3" }),
  ...
  chassis({ slug: "g21", code: "G21", name: { pl: "Seria 3 Touring VII", en: "3 Series Touring VII" }, years: "2019–2026", yearStart: 2019, yearEnd: 2026, tag: "volume", family: "3" }),
  ...
  chassis({ slug: "f32", code: "F32", name: { pl: "Seria 4 coupe", en: "4 Series coupe" }, years: "2013–2020", yearStart: 2013, yearEnd: 2020, tag: "volume", family: "4" }),
  chassis({ slug: "f33", code: "F33", name: { pl: "Seria 4 cabrio", en: "4 Series cabrio" }, years: "2013–2020", yearStart: 2013, yearEnd: 2020, tag: "volume", family: "4" }),
  chassis({ slug: "f36", code: "F36", name: { pl: "4 Gran Coupé", en: "4 Gran Coupé" }, years: "2014–2021", yearStart: 2014, yearEnd: 2021, tag: "volume", family: "4" }),
  ...
  chassis({ slug: "g22", code: "G22", name: { pl: "Seria 4 coupe II", en: "4 Series coupe II" }, years: "2020–", yearStart: 2020, yearEnd: null, tag: "volume", family: "4" }),
  chassis({ slug: "g23", code: "G23", name: { pl: "Seria 4 cabrio II", en: "4 Series cabrio II" }, years: "2020–", yearStart: 2020, yearEnd: null, tag: "volume", family: "4" }),
  chassis({ slug: "g26", code: "G26", name: { pl: "4 Gran Coupé", en: "4 Gran Coupé" }, years: "2021–", yearStart: 2021, yearEnd: null, tag: "volume", family: "4" }),
  ...
  chassis({ slug: "g30", code: "G30", name: { pl: "Seria 5 sedan VII", en: "5 Series sedan VII" }, years: "2017–2023", yearStart: 2017, yearEnd: 2023, tag: "volume", family: "5" }),
  chassis({ slug: "g31", code: "G31", name: { pl: "Seria 5 Touring VII", en: "5 Series Touring VII" }, years: "2017–2024", yearStart: 2017, yearEnd: 2024, tag: "volume", family: "5" }),
  ...
  chassis({ slug: "g60", code: "G60", name: { pl: "Seria 5 sedan VIII", en: "5 Series sedan VIII" }, years: "2024–", yearStart: 2024, yearEnd: null, tag: "volume", family: "5" }),
  ...
  chassis({ slug: "e82", code: "E82", name: { pl: "Seria 1 coupe", en: "1 Series coupe" }, years: "2007–2013", yearStart: 2007, yearEnd: 2013, tag: "volume", family: "1", extraSearch: ["135i", "n54"] }),
  ...
  chassis({ slug: "e88", code: "E88", name: { pl: "Seria 1 cabrio", en: "1 Series cabrio" }, years: "2007–2014", yearStart: 2007, yearEnd: 2014, tag: "volume", family: "1" }),
  ...
  chassis({ slug: "f40", code: "F40", name: { pl: "Seria 1 hatch III FWD", en: "1 Series hatch III FWD" }, years: "2019–2024", yearStart: 2019, yearEnd: 2024, tag: "volume", family: "1" }),
  chassis({ slug: "f22", code: "F22", name: { pl: "Seria 2 coupe", en: "2 Series coupe" }, years: "2014–2021", yearStart: 2014, yearEnd: 2021, tag: "volume", family: "2" }),
  chassis({ slug: "f45", code: "F45", name: { pl: "2 Active Tourer", en: "2 Active Tourer" }, years: "2014–2021", yearStart: 2014, yearEnd: 2021, tag: "volume", family: "2" }),
  ...
  chassis({ slug: "f44", code: "F44", name: { pl: "2 Gran Coupé", en: "2 Gran Coupé" }, years: "2020–", yearStart: 2020, yearEnd: null, tag: "volume", family: "2" }),
  chassis({ slug: "e84", code: "E84", name: { pl: "X1 I", en: "X1 I" }, years: "2009–2015", yearStart: 2009, yearEnd: 2015, tag: "volume", family: "x", extraSearch: ["x1"] }),
  chassis({ slug: "f48", code: "F48", name: { pl: "X1 II", en: "X1 II" }, years: "2015–2022", yearStart: 2015, yearEnd: 2022, tag: "volume", family: "x", extraSearch: ["x1"] }),
  chassis({ slug: "u11", code: "U11", name: { pl: "X1 III", en: "X1 III" }, years: "2022–", yearStart: 2022, yearEnd: null, tag: "volume", family: "x", extraSearch: ["x1"] }),
  chassis({ slug: "f39", code: "F39", name: { pl: "X2 I", en: "X2 I" }, years: "2018–2023", yearStart: 2018, yearEnd: 2023, tag: "volume", family: "x", extraSearch: ["x2"] }),
  ...
  chassis({ slug: "f25", code: "F25", name: { pl: "X3 II", en: "X3 II" }, years: "2010–2017", yearStart: 2010, yearEnd: 2017, tag: "volume", family: "x", extraSearch: ["x3"] }),
  chassis({ slug: "g01", code: "G01", name: { pl: "X3 III", en: "X3 III" }, years: "2017–2024", yearStart: 2017, yearEnd: 2024, tag: "volume", family: "x", extraSearch: ["x3"] }),
  ...
  chassis({ slug: "f26", code: "F26", name: { pl: "X4 I", en: "X4 I" }, years: "2014–2018", yearStart: 2014, yearEnd: 2018, tag: "volume", family: "x", extraSearch: ["x4"] }),
  chassis({ slug: "g02", code: "G02", name: { pl: "X4 II", en: "X4 II" }, years: "2018–", yearStart: 2018, yearEnd: null, tag: "volume", family: "x", extraSearch: ["x4"] }),
  ...
  chassis({ slug: "f15", code: "F15", name: { pl: "X5 III", en: "X5 III" }, years: "2013–2018", yearStart: 2013, yearEnd: 2018, tag: "volume", family: "x", extraSearch: ["x5"] }),
  chassis({ slug: "g05", code: "G05", name: { pl: "X5 IV", en: "X5 IV" }, years: "2018–", yearStart: 2018, yearEnd: null, tag: "volume", family: "x", extraSearch: ["x5"] }),
  chassis({ slug: "f85", code: "F85", name: { pl: "X5 M", en: "X5 M" }, years: "2015–2019", yearStart: 2015, yearEnd: 2019, tag: "famous", family: "x" }),
  chassis({ slug: "e71", code: "E71", name: { pl: "X6 I", en: "X6 I" }, years: "2008–2014", yearStart: 2008, yearEnd: 2014, tag: "volume", family: "x", extraSearch: ["x6"] }),
  chassis({ slug: "f16", code: "F16", name: { pl: "X6 II", en: "X6 II" }, years: "2014–2019", yearStart: 2014, yearEnd: 2019, tag: "volume", family: "x", extraSearch: ["x6"] }),
  chassis({ slug: "g06", code: "G06", name: { pl: "X6 III", en: "X6 III" }, years: "2019–", yearStart: 2019, yearEnd: null, tag: "volume", family: "x", extraSearch: ["x6"] }),
  chassis({ slug: "f86", code: "F86", name: { pl: "X6 M", en: "X6 M" }, years: "2015–2019", yearStart: 2015, yearEnd: 2019, tag: "famous", family: "x" }),
  chassis({ slug: "g07", code: "G07", name: { pl: "X7", en: "X7" }, years: "2019–", yearStart: 2019, yearEnd: null, tag: "volume", family: "x", extraSearch: ["x7"] }),
  ...
  chassis({ slug: "f01", code: "F01", name: { pl: "Seria 7 V", en: "7 Series V" }, years: "2008–2015", yearStart: 2008, yearEnd: 2015, tag: "volume", family: "luxury" }),
  chassis({ slug: "g11", code: "G11", name: { pl: "Seria 7 VI", en: "7 Series VI" }, years: "2015–2022", yearStart: 2015, yearEnd: 2022, tag: "volume", family: "luxury" }),
